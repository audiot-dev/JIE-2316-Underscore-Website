...
export default function FirstSection() {
    ...
    return (
        <Box sx={{ backgroundImage: 'url(/broiler-operation.jpg)',height: 800,backgroundPosition: 'center', backgroundRepeat: 'no-repeat',backgroundSize: 'cover',position: 'relative'}}>
